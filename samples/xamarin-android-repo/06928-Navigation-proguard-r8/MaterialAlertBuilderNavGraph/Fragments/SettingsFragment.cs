...
namespace com.companyname.MaterialAlertBuilderNavGraph.Fragments
{
    ...
    {
        private readonly string logTag = "GLM - Settings Fragment";
        internal ColorThemeListPreference colorThemeListPreference;
        ...
        private void ColorThemeListPreference_PreferenceChange(object sender, Preference.PreferenceChangeEventArgs e)
        {
            ...
            Log.Debug(logTag, "ColorThemeListPreference PreferenceChange - selectedTheme is " + colorThemeValue);
            Log.Debug(logTag, "ColorThemeListPreference PreferenceChange - calling Activity.Recreate()");
