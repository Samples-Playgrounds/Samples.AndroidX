...
namespace com.companyname.MaterialAlertBuilderNavGraph.Fragments
{
    public class HomeFragment : Fragment
    {
        ...
        public void HandleBackPressed()
        {
            ...
            // Had to add this for Android 12 devices becausue NainActivity's OnDestroy wasn't being called.
            // and therefore the OBDService plus the Notification wasn't being closed.
            Activity.Finish();
        }
        #endregion
    }
